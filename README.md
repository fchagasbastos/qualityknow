...
- Article_IR Know Quality_ChagasBastos-Kristensen_Functions.R — Analysis of the datasets. This generates the following tables and figures in folder called ResultFiles:
